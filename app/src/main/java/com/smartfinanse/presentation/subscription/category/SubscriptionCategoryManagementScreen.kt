...
@Composable
fun SubscriptionCategoryManagementScreen(
    onNavigateBack: () -> Unit,
    viewModel: SubscriptionCategoryManagementViewModel = hiltViewModel()
) {
    ...
    Scaffold(
        topBar = {
            SmartFinanseTopAppBar(
                title = { Text("Kategorie Subskrypcji") },
                navigationIcon = {
...
@Composable
private fun SubscriptionCategoryItemCard(
...
@Composable
private fun SubscriptionCategoryFormSheet(
    uiState: SubscriptionCategoryManagementUiState,
    ...
    val presetColors = listOf(
        "#E50914", "#1DB954", "#0078D7", "#FF9800", "#E91E63",
        "#9C27B0", "#607D8B", "#4CAF50", "#2196F3", "#00BCD4"
    )
    val presetIcons = listOf(
        "ic_entertainment", "ic_music", "ic_work", "ic_phone", "ic_health", "ic_game", "ic_other"
    )
